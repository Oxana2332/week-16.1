...
const audiModels = ["Audi A1", "Audi A2", "Audi A3", "Audi A4"];
const audiModelsValue = [100000, 150000, 200000, 250000];
const hondaModels = ["Honda Accord", "Honda Civic", "Honda Pilot"];
const hondaModelsValue = [201000, 100500, 303000];
const suzukiModels = ["Suzuki Jimny", "Suzuki Samurai", "Suzuki Grand Vitara"];
const suzukiModelsValue = [200000, 100000, 300000];
const volvoModels = ["Volvo C30", "Volvo S60", "Volvo XC60"];
const volvoModelsValue = [100000, 200000, 300000];
